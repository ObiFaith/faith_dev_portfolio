					...
					<div className="grid gap-12 md:w-11/12 mx-auto lg:w-full pt-10 items-center lg:grid-cols-2">
						<div className="grid gap-4 max-lg:text-center">
							...
							<p className="lg:text-lg text-base text-balance">
								I build scalable, secure web applications from idea to production.<br />Full-Stack Web Developer specializing in <span className="text-primary">Next.js, TypeScript, NestJS, and Python</span>, with experience building payment systems, APIs, microservices, and AI-powered tools.
							</p>
